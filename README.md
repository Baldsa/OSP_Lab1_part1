...
Программа на вход принимает 3 аргумента <program_name> <DIR> <Bytes>, <program_name> <DIR> <Bytes>
после программа начинает рекурсивно искать заданные байты, начиная с <DIRECTORY>. Так же в проект добавлены опции:
